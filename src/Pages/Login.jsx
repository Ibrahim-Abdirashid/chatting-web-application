...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      toast.success("Hadda waad gashay (Logged in)");
      navigate('/SomeChat');
    } catch (error) {
      ...
      <div className="py-28 max-w-6xl mx-auto h-screen flex flex-col justify-center items-center gap-10">
        ...
        >
          ...
          >
            ...
            {err && <span className="text-red-500 text-sm text-center font-medium">Email ama Password-ka aad galisay ayaa khaldan!</span>}
